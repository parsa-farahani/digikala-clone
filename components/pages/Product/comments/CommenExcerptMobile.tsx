...
const CommentExcerptMobile = (
   ...
   const {
      ...
      isPending: isLoadingCommentReactions,
   ...
   return (
      <article
         className={`border rounded-md lg:rounded-none w-[280px] px-3 py-4 lg:py-6 ${className}`}
         onClick={() => openModal()}
      >
         <div className="lg:flex justify-between items-start">
            <div>
               <p className="flex gap-2 items-center text-sm ">
                  ...
                  <span className="hidden gap-2 items-center">
                     <BsDot />
                     <time>4 اردیبهشت 1404</time>
                  </span>
               </p>
               <p className="mt-2">
                  <StarRating rating={finalRating} outOf={5} size={14} />
               </p>
         ...
         <p className="text-text-2 mt-6 line-clamp-3 text-sm leading-7">
            {
         ...
         <footer className="flex items-center justify-between">
            <div>
               <span className="text-sm items-center gap-2 hidden">
         ...
         >
            ...
            >
               <div className="py-4 px-4 w-full flex items-center justify-between sticky top-[0px] bg-light-1" >
                  <div>
                     <p className="flex gap-2 items-center text-sm ">
                        {
                           (commentData?.user)
                     ...
                     <p className="mt-2 flex items-center gap-2">
                        <StarRating rating={finalRating} outOf={5} size={14} />
                        <span className="gap-2 items-center text-xs text-text-2">
                           <time>4 اردیبهشت 1404</time>
                        </span>
                     </p>
                  </div>
               ...
               <div className="p-4 " >
                  <div className="" >
                     ...
                     <footer className="flex items-center justify-between">
                        <div>
                           <span className="text-xs items-center gap-2 flex">
                              <FaShop className="text-xs" />
                              دیجی‌کالا
                           </span>
                        </div>
...
export default CommentExcerptMobile;
